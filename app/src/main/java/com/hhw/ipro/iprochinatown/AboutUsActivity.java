...
public class AboutUsActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.pop_english:
                ...
                break;
            case R.id.faq:
                Intent intent = new Intent(AboutUsActivity.this, FAQActivity.class);
    ...
    private void showPopupWindow() {
        //设置contentView
        View contentView = LayoutInflater.from(AboutUsActivity.this).inflate(R.layout.popwindow_language, null);
        ...
        //显示PopupWindow
        View rootview = LayoutInflater.from(AboutUsActivity.this).inflate(R.layout.activity_about_us, null);
