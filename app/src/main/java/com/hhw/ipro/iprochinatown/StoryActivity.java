...
public class StoryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    void initView() {
        ...
        storyText.setMovementMethod(ScrollingMovementMethod.getInstance());
    }

    void initData(){
        mediaPlayer = MediaPlayer.create(this, R.raw.chinatown_audible_story);
        mediaPlayer.start();
        isPlayed = true;
    }
    ...
    private void showPopupWindow() {
        //设置contentView
        View contentView = LayoutInflater.from(StoryActivity.this).inflate(R.layout.popwindow_language, null);
        ...
        //显示PopupWindow
        View rootview = LayoutInflater.from(StoryActivity.this).inflate(R.layout.activity_story, null);
